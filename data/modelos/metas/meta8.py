...
# * vitamina E, cobre, zinc, manganeso, 
# * selenio, proteína, hierro, magnesio, 
# * fibra, calcio, fósforo, carbohidratos, 
# * ácido fólico, vitamina B1, vitamina B2, 
# * vitamina B6, potasio, vitamina B3
# ! REDUCIR: azúcar
...
from data.modelos.nutrientes.vitaminas import (A, C, E, acidoFolico, B1, B2, B6, B3)
from data.modelos.nutrientes.minerales import (Cobre, Zinc, Manganeso, Selenio, Hierro, Magnesio, Calcio, Fosforo,
Potasio)
from data.modelos.nutrientes.macronutrientes import proteinas, Fibra, Carbohidratos, Azucar

vitaminas = [B1, B2, B3, B6, A, acidoFolico, C, E]
minerales = [Fosforo, Hierro, Magnesio, Calcio, Selenio, Zinc, Potasio, Manganeso, Cobre]
...
coherenciaNutricionalMeta8 = crear_conjuntos_salida('coherenciaNutricionalMeta8')
print("coherenciaNutricionalMeta8:", id(coherenciaNutricionalMeta8))

reglas = [
    controlDifuso.Rule(aumentar['mal'] & reducir['mal'], coherenciaNutricionalMeta8['muyBaja']),
    controlDifuso.Rule(aumentar['mal'] & reducir['medio'], coherenciaNutricionalMeta8['baja']),
    controlDifuso.Rule(aumentar['medio'] & reducir['bien'], coherenciaNutricionalMeta8['media']),
    controlDifuso.Rule(aumentar['bien'] & reducir['medio'], coherenciaNutricionalMeta8['alta']),
    controlDifuso.Rule(aumentar['bien'] & reducir['bien'], coherenciaNutricionalMeta8['muyAlta'])
]
...
def evaluar_meta(inputs):
    ...
    salida, grados = ejecutar_sistema_difuso(reglas, 'coherenciaNutricionalMeta8', coherenciaNutricionalMeta8, inputs_sistema)
